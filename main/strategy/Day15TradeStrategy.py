...
class Day15TradeStrategy(ITradeStrategy):
    ...
    def __day_15min_sell_1(self, day, time, price):
        """
        信号一：【15分钟级别，在0轴以下】，【5分钟死叉】。——每5min判断一次
        信号二：【15分钟级别，在0轴以上】，【5分钟顶背离】，最后，【15分钟出现死叉】一定卖出。卖出类型8
        :param day:
        :param time:
        :return:
        """
    ...
    def __day_15min_sell_2(self, day, time, price):
        """
        信号一：【15分钟级别，在0轴以下】，【5分钟死叉】。——每5min判断一次
        信号二：【15分钟级别，在0轴以上】，【15分钟即将死叉】，最后，【15分钟出现死叉】一定卖出。卖出类型10
        :param day:
        :param time:
        :return:
        """
    ...
    def __day_60min_sell_1(self, day, time, price):
        """
        信号二的升级60分钟卖点方案：如果15分钟把60分钟带上0轴，则改看60分钟信号。即：15分钟买出信号出现时，60分钟MACD在0轴以下，15分钟卖出信号时，60分钟MACD在0轴以上了
        变更卖出条件为：【15分钟顶背离】。最后，则【60分钟死叉】一定卖出。卖出类型9.
        :param day:
        :param time:
        :return:
        """
    ...
    def __day_60min_sell_2(self, day, time, price):
        """
        信号二的升级60分钟卖点方案：如果15分钟把60分钟带上0轴，则改看60分钟信号。即：15分钟买出信号出现时，60分钟MACD在0轴以下，15分钟卖出信号时，60分钟MACD在0轴以上了
        变更卖出条件为：【60分钟即将死叉】。最后，则【60分钟死叉】一定卖出。卖出类型11.
        :param day:
        :param time:
        :return:
        """
